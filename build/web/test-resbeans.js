...
TestSupport.prototype = {    
    ...
    getMethodMimeTypeCombo : function (resource) {
        ...
        str += "</select></span></td><td width=46/><td><a class='Btn1_sun4 Btn1Hov_sun4' onclick='ts.testResource()'>Тест</a></td></tr></tbody></table>";
        return str;
    },
    ...
    doShowDynamicResource : function (uri, mName, mediaType) {
        ...
        str += "</span></td><td><a class='Btn1_sun4 Btn1Hov_sun4' onclick='ts.testResource()'>Тест</a></td></tr></tbody></table><br/>";
        ...
        this.updatepage('request', '<span class=bld>Ресурс:</span> '+uriLink+' <br/>(<a href="'+req+'" class=Hyp_sun4 target="_blank"><span>'+this.getDisplayURL(req, 90)+'</span></a>)');
    },
    ...
    getHttpRequest : function() {
        ...
        {    // Internet Explorer 6.0+, 5.0+
            ...
            catch (e)
            {
                ...
                {
                    ts.debug("Этот обозреватель не поддерживает AJAX!");
                }
            }
        }
        return xmlHttpReq;
        ...
        try {
            ...
            if (this.isResponseReady(method, xmlHttpReq, content, monitor)) {
              ...
              if(rtext == undefined || rtext == '' || rtext.indexOf('HTTP Status') != -1) {
                  var err = method+' ЗапросFailed RequestFailed --> Статус: (' + status+')\n<br/>'+
